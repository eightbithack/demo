...
enum TokenType {
    ...
    //actions
    PAY, CREATE, PUT, GAIN, GET, CAST, PREVENT, DRAW, DEAL, EQUIP, ATTACK, BLOCK, ATTACH, EXILE, SACRIFICE, DESTROY,
    ...
    //logic
    WHENEVER, WHEN, WITH, THATD_BE, IF_KICKED, CANT, ON_THEM,

    //groupings
    OR, AND,

    //references
    IT, THAT, YOU, OPPONENT, OTHER, ANOTHER, CARDNAME, SPELLNAME, TARGET, EQUIPPED_CREATURE, TO, EACH, UP_TO, NAMED,
